            ...
            >
                ...
                <div className="flex flex-col space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-8 pt-4">
                        {/* QR Code Section */}
                        <motion.div className="flex flex-col items-center space-y-3 p-4 glass-card rounded-2xl" variants={itemVariants}>
                            <div className="p-2 bg-white rounded-lg">
                                <img src={qrCodeUrl} alt={qrCodeAlt} className="w-28 h-28" />
                            </div>
                            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Scan to Download</p>
                        </motion.div>
                    ...
                    {githubDownloadUrl && (
                        <motion.div variants={itemVariants} className="pt-4">
                            <a
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#24292e] text-white font-semibold transition-all hover:scale-105 active:scale-95 shadow-lg shadow-black/10"
                            >
