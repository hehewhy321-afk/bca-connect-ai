...
const testimonials = [
  {
    ...
    content:
      "The AI study assistant helped me ace my database exam. It's like having a personal tutor available 24/7!",
    rating: 5,
  },
  {
    name: "Priya Thapa",
    ...
    content:
      "The project showcase platform connected me with industry mentors. I landed my first internship through the alumni network!",
    rating: 5,
  },
  {
    name: "Rohan Maharjan",
    ...
    content:
      "From coding workshops to hackathons, BCA Association gave me the skills and confidence to start my tech career.",
    rating: 5,
  },
];
...
export function CommunitySection() {
  return (
    <section
      id="community"
      className="py-20 md:py-32 bg-gradient-to-br from-primary via-primary/95 to-accent/80 relative overflow-hidden"
    >
      {/* Pattern */}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-primary-foreground rounded-2xl p-6 shadow-xl"
            >
              {/* Quote Icon */}
